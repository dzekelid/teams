...
- name: Bitbucket Parameters Teams Username Hooks U
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/teams/master/_listings/bitbucket/teams-username-hooks-uid-parameters.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/teams/master/_listings/bitbucket/teams-username-hooks-uid-parameters-postman.md
x-common:
- type: x-developer
